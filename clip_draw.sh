...
python code/clip_draw.py --experiment $experiment --script $script --semantic_concept "$concept" --optimized_region $optimized_region --word $word --seed $seed --font $font --use_wandb 0 --wandb_user $wandb_user --log_dir "output_clip_draw" --use_ocr_loss 0 --use_conformal_loss 0 --conformal_loss_weight 0.5
