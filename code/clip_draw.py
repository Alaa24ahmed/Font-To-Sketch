...
def init_shapes(svg_path, trainable: Mapping[str, bool]):
    ...
    for group in shape_groups_init:
        if group.stroke_color is None:
            group.stroke_color = torch.tensor([0.0, 0.0, 0.0, 1.0])  # RGBA for black
...
# concept = "fox"
# svg_path="/home/ahmed.sharshar/Desktop/Alaa/Font-To-Sketch/output/arabic/06_ثعلب_012_seed_42_angels_loss_0.5/svg-init/init.svg"
prompt = cfg.caption
...
augment_trans = transforms.Compose([
    ...
    # transformsGrayscale(num_output_channels=3),
...
if osp.isdir(f'/home/ahmed.sharshar/Desktop/Alaa/Font-To-Sketch/output_clip_draw/{concept}/'):
    pass
else:
...
for t in range(args.num_iter):
    ...
    # img = img[:, :, :1]  # Convert to grayscale by keeping one channel
    
    if t % 5 == 0:
        pydiffvg.imwrite(img.cpu(), f'/home/ahmed.sharshar/Desktop/Alaa/Font-To-Sketch/output_clip_draw/{concept}/iter_{int(t/5)}.png', gamma=gamma)
...
save_svg.save_svg(filename, canvas_width, canvas_height, shapes, shape_groups)
